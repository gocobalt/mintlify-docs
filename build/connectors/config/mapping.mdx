...
### Dynamic mapping
Scenarios where the fields cannot be pre-defined for mapping and changes dynamically cannot be mapped using static mapping. For this Refold provides a feature to load your fields dynamically using [DataSource](https://docs.gocobalt.io/build/connectors/config/datasource). 
