...
/>
```
You need to provide the [Workflow Id](https://docs.gocobalt.io/api-reference/config/get-all-config) and [Session Token](https://docs.gocobalt.io/api-reference/session-token/generate-token-for-linked-account).
