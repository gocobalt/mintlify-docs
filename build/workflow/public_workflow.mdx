...
```
<Tip>
Learn more about the Create Public Workflow API [here](https://docs.gocobalt.io/api-reference/private_workflows/create_private_workflow).
</Tip>
...
```
<Tip>
Learn more about the Create Draft of Public Workflow API [here](https://docs.gocobalt.io/api-reference/private_workflows/get_draft).
</Tip>
