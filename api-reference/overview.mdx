...
title: Overview
---
Cobalt's API allows developers to integrate and automate various functionalities within the Cobalt platform. This guide provides an overview of how to find the API key, descriptions of each available resource, and details about the rate limits of the Cobalt API.
