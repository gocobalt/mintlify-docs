---
title: 'Update event'
api: put /api/v2/public/event/:event_id
---

This API updates a Cobalt [event](https://app.gocobalt.io/your-app#:~:text=Add%20events%20to%20send%20data%20from%20your%20app%20to%20other%20apps). 
