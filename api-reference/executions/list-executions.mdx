...
<RequestExample>
```bash All Executions
curl --location 'https://app.refold.ai/api/v2/public/execution?page=1&limit=10&status=All&execution_source=All' \
  --header 'x-api-key: <YOUR_API_KEY>' \
  --header 'linked_account_id: <YOUR_LINKED_ACCOUNT_ID>'
```
```bash Filter by Status (ERRORED)
curl --location 'https://app.refold.ai/api/v2/public/execution?page=1&limit=10&status=ERRORED' \
  --header 'x-api-key: <YOUR_API_KEY>' \
  --header 'linked_account_id: <YOUR_LINKED_ACCOUNT_ID>'
```
```bash Filter by Date Range
curl --location 'https://app.refold.ai/api/v2/public/execution?page=1&limit=10&status=All&start_date=2026-03-10&end_date=2026-03-14' \
  --header 'x-api-key: <YOUR_API_KEY>' \
  --header 'linked_account_id: <YOUR_LINKED_ACCOUNT_ID>'
```
</RequestExample>
