...
curl --location --request PUT \
  'https://app.refold.ai/api/v2/public/workflow/<workflow_id>/publish' \
...
```bash cURL
curl --location \
  'https://app.refold.ai/api/v2/public/workflow/<workflow_id>/edit' \
  --header 'Authorization: Bearer <session_token>'
```
...
```bash cURL
curl --location --request PUT \
  'https://app.refold.ai/api/v2/public/workflow/<draft_workflow_id>/publish' \
  --header 'Authorization: Bearer <session_token>' \
  --header 'x-api-key: <your_api_key>' \
  --header 'environment: test' \
  --header 'Content-Type: application/json' \
