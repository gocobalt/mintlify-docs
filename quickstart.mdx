...
<Tip>
Learn more about API Proxy [here](https://docs.gocobalt.io/guides/developer-settings/api_proxy).
</Tip>
...
[Linked Accounts](https://docs.gocobalt.io/guides/platform/linked-account/general) refers to the end-users or customers of our users who utilize the integrations built using the Cobalt platform.
...
<Info>
You can also build your own UI for end-users using our SDKs or APIs and [Auth Flows](https://docs.gocobalt.io/concepts/auth-flows).
</Info>
...
2. **Event based triggers** which triggers when an event is called on Cobalt. You can check which Event is added to the workflow by checking the **Start Node** of the workflow.
    ...
    - To start the workflow execution, go to [**Try API**](https://docs.gocobalt.io/guides/platform/tryapi) section in Cobalt, provide the required details and click on `Fire Event`.
    <img height="200" src="/images/Guides/Platform/try-api.png" alt="Try API Section in Cobalt"/>

Once the Event is fired, you can see the Event and Execution logs of your workflow by navigating to [**Logs**](https://docs.gocobalt.io/guides/platform/workflow-logs) section.
