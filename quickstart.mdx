...
To get started, sign up for a free account at [https://www.gocobalt.io/create-account](https://www.gocobalt.io/create-account). After creating an account, you will have access to your production and testing API keys to build and test how Cobalt works.
