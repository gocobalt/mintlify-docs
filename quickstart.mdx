...
<img height="200" src="/images/hero-light.svg" alt="How to find the API Keys on Cobalt's dashboard"/>
...
<img height="200" src="/images/hero-light.svg" alt="Create a new event"/>
