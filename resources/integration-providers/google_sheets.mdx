...
---
To setup your Google Sheets app in Cobalt for OAuth, you will need the following credentials from your [Google Cloud Console dashboard](https://console.cloud.google.com/projectselector2/home/dashboard?supportedpurview=project):
- Client ID
- Client Secret
- Scopes
...
10. Navigate to `Credentials` in the left menu under `APIs and services` and select the Web Client under `OAuth 2.0 Client IDs`. Copy the **Client ID** and **Client Secret** under `Additional information` section.
...
Once the above setup is completed, you can create orchestrations of your use-cases using Google Sheets actions and triggers. Following are the set of Google Sheets actions and triggers
supported by Cobalt.

<Tabs>
  <Tab title="Actions">
     1. [HTTP Request](https://docs.gocobalt.io/resources/integration-providers/google_sheets#actions-and-triggers) - Make HTTP API calls to any Google Sheets documented REST APIs.
     2. [Create A Spreadsheet](https://docs.gocobalt.io/resources/integration-providers/google_sheets#actions-and-triggers) - Create A New Spreadsheet In Google Sheets.
     3. [Create a Worksheet](https://docs.gocobalt.io/resources/integration-providers/google_sheets#actions-and-triggers) - Create A New worksheet in Google Sheets.
     4. [Add a new row](https://docs.gocobalt.io/resources/integration-providers/google_sheets#actions-and-triggers) - Add a new row in Google Sheets.
