...
7. Enter the Callback URL as provided in your Pardot settings page in Refold. Go to your [`Apps catalog`](https://app.gocobalt.io/apps) > Search for `Pardot` > `Settings` > `Use your credentials` > `Callback Url`.
8. Select the required scopes, atleast the scopes selected in your Refold Pardot settings page.
