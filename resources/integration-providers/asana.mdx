...
<Tabs>
  ...
  <Accordion title="Task">
     1. [Create Task](https://docs.gocobalt.io/resources/integration-providers/asana#actions-and-triggers) - Create a task in Asana.
     2. [Update Task](https://docs.gocobalt.io/resources/integration-providers/asana#actions-and-triggers) - Update a task in Asana.
     3. [Delete Task](https://docs.gocobalt.io/resources/integration-providers/asana#actions-and-triggers) - Delete a task in Asana.
     </Accordion>
     <Accordion title="Project">
     4. [Create Project](https://docs.gocobalt.io/resources/integration-providers/asana#actions-and-triggers) - Create a project in Asana.
      </Accordion>
     <Accordion title="Section">
     5. [Create Section](https://docs.gocobalt.io/resources/integration-providers/asana#actions-and-triggers) - Create a section in a project in Asana.
      </Accordion>
     <Accordion title="Others">
     6. [HTTP Request](https://docs.gocobalt.io/resources/integration-providers/asana#actions-and-triggers) - Make HTTP API calls to any Asana documented REST APIs.
       </Accordion>
</AccordionGroup>
  </Tab>
