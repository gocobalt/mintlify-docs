...
<Tabs>
  ...
  <AccordionGroup>
    <Accordion title="Upload File">
     1. **Upload a file using url** - Enter file name and hosted url to upload a file to your Microsoft OneDrive.
     2. **Upload using relative path to root or folderId** - Upload file using relative path in your Microsoft OneDrive.
     </Accordion>
     <Accordion title="Others">
     3. **HTTP Request** - Make HTTP API calls to any Microsoft OneDrive documented REST APIs.
</Accordion>
</AccordionGroup>
  </Tab>
