...
5. Go to your [`Apps catalog`](https://app.gocobalt.io/apps) in **Cobalt** > Search for `Microsoft One Drive` > `Settings` > `Use your credentials` > `Callback Url` > Copy it.
...
<Info>**Offline_access** and **openid** scope will be present under **Delegated permissions** in **Microsoft Graph**</Info>
<img height="200" src="/images/Msonedrive/onedrive_config.png" alt="Setting up OneDrive Developer app"/>
...
<img height="200" src="/images/Msonedrive/onedrive_credentials.png" alt="Getting Client Secret"/>

11. Navigate to `Overview` in the side menu > `Essentials` tab > Copy the **Client ID** under `Application (client) ID` and the **App ID**.
<img height="200" src="/images/Msonedrive/onedrive_id.png" alt="Getting Client ID"/>
...
<img height="200" src="/images/Msonedrive/onedrive_cobalt.png" alt="Setting up application client credentials"/>
...
<img height="200" src="/images/Msonedrive/onedrive_scopes.png" alt="OAuth Scopes"/>
