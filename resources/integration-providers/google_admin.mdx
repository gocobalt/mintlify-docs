...
<Tabs>
  <Tab title="Actions">
     1. [HTTP Request](https://docs.gocobalt.io/resources/integration-providers/google_admin#actions-and-triggers) - Make HTTP API calls to any Google Admin documented REST APIs.
     2. [Get User Activities For A Particular Application](https://docs.gocobalt.io/resources/integration-providers/google_admin#actions-and-triggers) - Get User Activities For A Particular Application in Google Admin.
