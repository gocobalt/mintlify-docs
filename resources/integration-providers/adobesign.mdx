...
1. Adobe Developer account. You can create one [here](https://developers.pipedrive.com/#signup).
...
To create a Adobe Sign app and aquire the above mentioned credentials, please follow the steps mentioned below:
