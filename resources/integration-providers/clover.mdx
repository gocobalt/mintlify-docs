...
<img height="200" src="/images/Clover/clover_navigation.png" alt="Navigation for App setup"/>
...
5. Go to your [`Apps catalog`](https://app.gocobalt.io/apps) in **Cobalt** > Search for `Clover` > `Settings` > `Use your credentials` > `Callback Url` > Copy it. Paste the Callback URL and click on the `Save` button.
...
<img height="200" src="/images/Clover/clover_config.png" alt="Setting up Clover Developer app"/>

8. Scroll down in the **OAuth and access scopes** section and copy the **Client ID** and **Client Secret** from the Client ID section.
<img height="200" src="/images/Clover/clover_credentials.png" alt="Getting Credentials"/>
...
#### 2. Submit your production developer account for approval
