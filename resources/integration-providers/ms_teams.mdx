...
5. Go to your [`Apps catalog`](https://app.gocobalt.io/apps) in **Cobalt** > Search for `Microsoft Teams` > `Settings` > `Use your credentials` > `Callback Url` > Copy it.
6. Under the **Redirect URI** section, select **Platform** as `Web`, paste the **Callback Url** as the URL and click `Register`. 
<img height="200" src="/images/Msteams/teams_register.png" alt="App Registration"/>
<Info>
If you already have an app created, then follows these steps to add Redirect URL: 

Select your Application > Select **Authentication** in side menu under `Manage` > Under **Platform configurations**, press the  **Add a platform** button > Select **Web** > Paste the Callback Url > Click on **Configure** > Click **Save** button at the bottom.
</Info>
...
Select the OAuth App created for Cobalt and follow **Step 7** and **8** [above](https://docs.gocobalt.io/resources/integration-providers/ms_teams#creating-an-app-in-microsoft-azure).
