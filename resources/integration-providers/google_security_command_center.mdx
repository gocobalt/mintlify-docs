...
10. Go to `Enabled APIs and services` in the left menu under **APIs and services** > Click on `+ Enable APIs and Services` > Search for `Cloud Resource Manager API` > Click on `Enable`.
