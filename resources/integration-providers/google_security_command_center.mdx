...
---
To setup your Google Security Command Center app in Refold for OAuth, you will need the following credentials from your [Google Cloud Console dashboard](https://console.cloud.google.com/projectselector2/home/dashboard?supportedpurview=project):
- Client ID
- Client Secret
- Scopes
...
5. Go to your [`Apps catalog`](https://app.gocobalt.io/apps) in **Refold** > Search for `Google Security Command Center` > `Settings` > `Use your credentials` > `Callback Url` > Copy it.
...
Navigate to  `Cloud Console dashboard` > Select the **Project** created for Refold > Follow the steps 8 and 9 mentioned [above](/resources/integration-providers/google_security_command_center#creating-an-app-in-google-security-command-center) for adding scopes. 
