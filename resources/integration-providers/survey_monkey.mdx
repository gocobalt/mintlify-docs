---
title: Setup
description: Connect to your SurveyMonkey app for OAuth.
---
To setup your SurveyMonkey app in Cobalt for OAuth, you will need the following credentials from your [Survey Monkey Developer account](https://developer.surveymonkey.com/):
- Client ID
- Client Secret
- Scopes
...
To create a SurveyMonkey app and aquire the above mentioned credentials, please follow the steps mentioned below:
