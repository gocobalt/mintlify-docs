...
<img height="200" src="/images/Salesforce/Salesforce_navigate.png" alt="Navigation for App setup"/>
...
To use Salesforce webhooks as triggers in your workflows, your end-users need to add the API base URL of Cobalt as a Remote Site in Salesforce to receive the events successfully.
...
<Steps>
  <Step title="Navigation">
    ...
    <img height="200" src="/images/Salesforce/Salesforce_remote.png" alt="Remote Site Settings in Salesforce"/>
  </Step>
  ...
  <Step title="Add URL">
    Provide a **Name** of the Remote Site, add `https://api.gocobalt.io` under **Remote Site URL** and click on `Save`.
        <img height="200" src="/images/Salesforce/Salesforce_remote_2.png" alt="Remote Site Settings in Salesforce"/>
  </Step>
</Steps>

<Check>
You have successfully added the API base URL of Cobalt in Salesforce for the triggers.
</Check>
