...
Select the OAuth App created for Cobalt and follow **Step 7** and **8** [above](https://docs.gocobalt.io/resources/integration-providers/ms365#creating-an-app-in-microsoft-azure).
...
<Tabs>
  <Tab title="Actions">
     1. [HTTP Request](https://docs.gocobalt.io/resources/integration-providers/msonedrive#actions-and-triggers) - Make HTTP API calls to any Microsoft OneDrive documented REST APIs.
     2. [Upload a file using url](https://docs.gocobalt.io/resources/integration-providers/msonedrive#actions-and-triggers) - Enter file name and hosted url to upload a file to your Microsoft OneDrive.
     3. [Upload using relative path to root or folderId](https://docs.gocobalt.io/resources/integration-providers/msonedrive#actions-and-triggers) - Upload file using relative path in your Microsoft OneDrive.
