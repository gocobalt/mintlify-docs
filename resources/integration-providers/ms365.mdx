---
title: Setup
description: Connect to your Microsoft Dynamics 356 app for OAuth.
---
To setup your Microsoft Dynamics 365 app in Cobalt for OAuth, you will need the following credentials from your [Microsoft Azure account](https://azure.microsoft.com/en-gb/):
- Client ID
- Client Secret
- Scopes
...
To create a Microsoft Dynamics 365 app and aquire the above mentioned credentials, please follow the steps mentioned below:
...
Once the above setup is completed, you can create orchestrations of your use-cases using Dynamics 365 actions and triggers. Following are the set of Dynamics 365 actions and triggers
supported by Cobalt.

<Tabs>
  <Tab title="Actions">
     1. [HTTP Request](https://docs.gocobalt.io/resources/integration-providers/ms365#actions-and-triggers) - Make HTTP API calls to any Microsoft Dynamics 365 documented REST APIs.
     2. [Get users with PlanName](https://docs.gocobalt.io/resources/integration-providers/ms365#actions-and-triggers) - Get users with PlanName in Microsoft Dynamics 365.
