...
To create a Zoom app and aquire the above mentioned credentials, please follow the steps mentioned below:
...
<img height="200" src="/images/Zoom/Zoom_cobalt.png" alt="Setting up application client credentials"/>
...
Once the above setup is completed, you can create orchestrations of your use-cases using Zoom actions and triggers. An action with any API of Zoom can be created by using the **HTTP Request** Action.