...
<Tabs>
  <Tab title="Actions">
     1. [HTTP Request](https://docs.gocobalt.io/resources/integration-providers/googledrive#actions-and-triggers) - Make HTTP API calls to any Google Drive documented REST APIs.
     2. [Create A New Folder In Drive](https://docs.gocobalt.io/resources/integration-providers/googledrive#actions-and-triggers) - Create A New Folder In Google Drive.
     3. [Upload File By URL](https://docs.gocobalt.io/resources/integration-providers/googledrive#actions-and-triggers) - Upload File By URL in Google Drive.
