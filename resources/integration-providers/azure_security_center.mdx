...
Once the above setup is completed, you can create orchestrations of your use-cases using Microsoft 365 actions and triggers. Following are the set of Azure Security Centre actions and triggers
supported by Cobalt.
