...
Navigate to  `Cloud Console dashboard` > Select the **Project** created for Cobalt > Follow the steps 8 and 9 mentioned [above](https://docs.gocobalt.io/resources/integration-providers/googledrive#creating-an-app-in-google-drive) for adding scopes. 
...
<Tabs>
  <Tab title="Actions">
     1. [HTTP Request](https://docs.gocobalt.io/resources/integration-providers/googlesheets#actions-and-triggers) - Make HTTP API calls to any Google Sheets documented REST APIs.
     2. [Create A Spreadsheet](https://docs.gocobalt.io/resources/integration-providers/googlesheets#actions-and-triggers) - Create A New Spreadsheet In Google Sheets.
     3. [Create a Worksheet](https://docs.gocobalt.io/resources/integration-providers/googlesheets#actions-and-triggers) - Create A New worksheet in Google Sheets.
     4. [Add a new row](https://docs.gocobalt.io/resources/integration-providers/googlesheets#actions-and-triggers) - Add a new row in Google Sheets.
