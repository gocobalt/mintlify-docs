---
title: Setup
description: Connect to your Microsoft 356 app for OAuth.
---
To setup your Microsoft 365 app in Cobalt for OAuth, you will need the following credentials from your [Microsoft Azure account](https://azure.microsoft.com/en-gb/):
- Client ID
- Client Secret
- Scopes
...
To create a Microsoft 365 app and aquire the above mentioned credentials, please follow the steps mentioned below:
...
<img height="200" src="/images/Ms365/ms365_config.png" alt="Setting up Microsoft 365 Developer app"/>
...
Select the OAuth App created for Cobalt and follow **Step 7** and **8** [above](https://docs.gocobalt.io/resources/integration-providers/ms_365#creating-an-app-in-microsoft-azure).
...
<Tabs>
  <Tab title="Actions">
     1. [HTTP Request](https://docs.gocobalt.io/resources/integration-providers/ms_365#actions-and-triggers) - Make HTTP API calls to any Microsoft 365 documented REST APIs.
     2. [Get users with PlanName](https://docs.gocobalt.io/resources/integration-providers/ms_365#actions-and-triggers) - Get users with PlanName in Microsoft 365.
