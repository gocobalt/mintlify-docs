...
<Tabs>
  <Tab title="Actions">
     1. [HTTP Request](https://docs.gocobalt.io/resources/integration-providers/clickup#actions-and-triggers) - Make HTTP API calls to any ClickUp documented REST APIs.
     2. [Create Task](https://docs.gocobalt.io/resources/integration-providers/clickup#actions-and-triggers) - Create a task in ClickUp.
     3. [Update Task](https://docs.gocobalt.io/resources/integration-providers/clickup#actions-and-triggers) - Update a task in ClickUp.
     4. [Delete Task](https://docs.gocobalt.io/resources/integration-providers/clickup#actions-and-triggers) - Delete a task in ClickUp.
