...
<Tabs>
  ...
  <Accordion title="Tasks">
     1. [Create Task](https://docs.gocobalt.io/resources/integration-providers/clickup#actions-and-triggers) - Create a task in ClickUp.
     2. [Update Task](https://docs.gocobalt.io/resources/integration-providers/clickup#actions-and-triggers) - Update a task in ClickUp.
     3. [Delete Task](https://docs.gocobalt.io/resources/integration-providers/clickup#actions-and-triggers) - Delete a task in ClickUp.
     </Accordion>
     <Accordion title="Others">
     4. [HTTP Request](https://docs.gocobalt.io/resources/integration-providers/clickup#actions-and-triggers) - Make HTTP API calls to any ClickUp documented REST APIs.
</Accordion>
</AccordionGroup>
  </Tab>
  <Tab title="Triggers">
