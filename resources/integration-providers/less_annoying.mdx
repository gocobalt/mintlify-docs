...
2. Click on your profile picture or name in the top-right corner and select `Settings`.
...
3. Scroll down to the `API` section or navigate directly to [https://www.lessannoyingcrm.com/settings/api](https://www.lessannoyingcrm.com/settings/api).
...
<img
  height="200"
  src="/images/lessannoyingcrm/lessannoyingcrm_credentials.png"
