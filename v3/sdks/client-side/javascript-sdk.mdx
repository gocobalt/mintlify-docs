...
1. **Create a Linked Account** for your user using the [Node.js SDK](/v3/sdks/server-side/nodejs-sdk#createlinkedaccount) or [API](/v3/api-reference/linked-accounts/create-linked-account)
2. **Generate a Session Token** using the [Node.js SDK](/v3/sdks/server-side/nodejs-sdk#gettokenforlinkedaccount) or [API](/v3/api-reference/session-tokens/generate-session-token)
