...
<Tip>Use a [Custom Code node](/v3/concepts/workflows/nodes/custom-code) before the Agent node to prepare and format complex input data for better prompt quality.</Tip>
