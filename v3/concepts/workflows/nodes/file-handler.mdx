...
<Info>This node is recommended for files **greater than 5MB**. For smaller files, use the [CSV/Excel node](/v3/concepts/workflows/nodes/csv-excel) instead.</Info>
...
<AccordionGroup>
  <Accordion title="SFTP Connection Parameters">
    ...
    <Tip>Store SFTP credentials as environment variables under [**Organization > Settings > Environment Variable**](/v3/platform-settings/workspace-settings/environment-variables) for secure, reusable configuration.</Tip>
  </Accordion>
...
<Tip>Store SFTP credentials securely as environment variables under [**Organization > Settings > Environment Variable**](/v3/platform-settings/workspace-settings/environment-variables) rather than hardcoding them in workflows.</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Data Converter node" icon="file-import" href="/v3/concepts/workflows/nodes/csv-excel">
    Parse CSV/Excel files after reading.
  </Card>
  <Card title="CSV/Excel node" icon="file-csv" href="/v3/concepts/workflows/nodes/csv-excel">
