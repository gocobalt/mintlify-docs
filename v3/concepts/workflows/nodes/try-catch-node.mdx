...
<CardGroup cols={2}>
  ...
  <Card title="Log node" icon="file-lines" href="/v3/concepts/workflows/nodes/log-node">
    Record error details for debugging.
  </Card>
  <Card title="Tables node" icon="table" href="/v3/concepts/workflows/nodes/tables">
