...
You read from a Data Ref inside a [workflow](/v3/workflows/overview) by adding the Data Ref node and choosing one of the lookup actions. Reads work in both directions, so you can start from either side of the mapping.
...
<CardGroup cols={2}>
  <Card title="Workflows overview" icon="diagram-project" href="/v3/workflows/overview">
