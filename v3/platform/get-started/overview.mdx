...
<Steps>
  ...
  <Step title="Make your first API call">
    Grab your API key from **Settings > Credentials** in the [Refold Console](https://uat.refold.ai/settings/credentials), then make your first request. See the [quickstart](/v3/platform/get-started/quickstart) for a complete walkthrough.
  </Step>
