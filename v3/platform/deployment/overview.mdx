...
If you're new here, read the [Control Plane](/v3/platform/deployment/control-plane) reference first to understand the deployment models, then follow the install guide for the option you choose.
...
See [Control Plane](/v3/platform/deployment/control-plane) for how the control plane and data plane split across each model.
...
<CardGroup cols={2}>
  ...
  <Card title="Air-gapped" icon="network-wired" href="/v3/platform/deployment/kubernetes/air-gapped">
    Install into a disconnected environment with a self-contained offline package.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Go-live checklist" icon="circle-check" href="/v3/platform/deployment/go-live-checklist">
    Verify everything is production-ready before you launch.
  </Card>
</CardGroup>
