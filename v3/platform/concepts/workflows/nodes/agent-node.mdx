...
<Tip>Use a [Custom Code node](/v3/platform/concepts/workflows/nodes/custom-code) before the Agent node to prepare and format complex input data for better prompt quality.</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="What is MCP?" icon="robot" href="/v3/mcp/get-started/what-is-mcp">
