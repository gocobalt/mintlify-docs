...
<Info>This node is recommended for files **greater than 5MB**. For smaller files, use the [CSV/Excel node](/v3/workflows/nodes/csv-excel) instead.</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Data Converter node" icon="file-import" href="/v3/workflows/nodes/csv-excel">
    Parse CSV/Excel files after reading.
  </Card>
  <Card title="CSV/Excel node" icon="file-csv" href="/v3/workflows/nodes/csv-excel">
