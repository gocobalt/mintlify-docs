...
<CardGroup cols={2}>
  <Card title="Workflow overview" href="/v3/workflows/overview">
    The fundamentals of workflows, triggers, and nodes.
  </Card>
  <Card title="Templating and variables" href="/v3/workflows/overview">
  ...
  <Card title="Log node" href="/v3/workflows/nodes/log-node">
