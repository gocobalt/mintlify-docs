...
<Note>
Test-run variables require the workflow testing prerequisites to be satisfied. See [Workflow Testing](/developer/configure/workflows/workflow-testing) for the full setup.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Workflow Testing" icon="flask" href="/developer/configure/workflows/workflow-testing">
  ...
  <Card title="API Proxy" icon="route" href="/developer/configure/basic/api-proxy">
