...
- [Rule Node](/v3/developer/workflows/nodes/rule) to create conditional branches that lead to Terminate
- [Response Node](/v3/developer/workflows/nodes/response) to return data before terminating via Workflow API
- [Sub Flows Node](/v3/developer/workflows/nodes/sub-flows) to use Terminate for early exit in reusable workflows