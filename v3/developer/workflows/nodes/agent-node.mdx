...
<Tip>Use a [Custom Code Node](/v3/developer/workflows/nodes/custom-code) before the Agent Node to prepare and format complex input data for better prompt quality.</Tip>

## What's Next

- [MCP Overview](/v3/mcp-ai-agents/overview/what-is-mcp) to understand how agents interact with enterprise systems
- [Transform Node](/v3/developer/workflows/nodes/transform) to process agent outputs with JSONata
- [Rule Node](/v3/developer/workflows/nodes/rule) to add conditional logic based on agent responses
- [Loop Node](/v3/developer/workflows/nodes/loop) to process multiple items with the agent