...
<Info>This node is recommended for files **greater than 5MB**. For smaller files, use the [CSV/Excel Node](/v3/developer/workflows/nodes/csv-excel) instead.</Info>
...
- [Loop Node](/v3/developer/workflows/nodes/loop) to process multiple files from a directory listing
- [Data Converter Node](/v3/developer/workflows/nodes/data-converter-node) to parse CSV/Excel files after reading
- [CSV/Excel Node](/v3/developer/workflows/nodes/csv-excel) for files smaller than 5MB
- [Rule Node](/v3/developer/workflows/nodes/rule) to add conditional logic based on file operations