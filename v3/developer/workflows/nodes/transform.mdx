...
- [Custom Code Node](/v3/developer/workflows/nodes/custom-code) for complex data processing with JavaScript or Python
- [Data Mapper Node](/v3/developer/workflows/nodes/data-mapper) for simple field name transformations
- [Rule Node](/v3/developer/workflows/nodes/rule) to add conditional transformation logic
- [Loop Node](/v3/developer/workflows/nodes/loop) to apply transformations across arrays