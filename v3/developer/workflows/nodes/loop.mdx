...
- [Tables Node](/v3/developer/workflows/nodes/tables) to store loop results for use outside the loop
- [Rule Node](/v3/developer/workflows/nodes/rule) for conditional logic within loops
- [Custom Code Node](/v3/developer/workflows/nodes/custom-code) for complex data processing per iteration