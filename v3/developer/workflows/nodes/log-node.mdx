...
- [Custom Code Node](/developer-guide/workflows/nodes/custom-code) for complex data processing and conditional logging
- [Rule Node](/developer-guide/workflows/nodes/rule) to add conditional logic that determines when to log
- [Workflow Testing](/developer-guide/workflows/testing) to verify log output during development