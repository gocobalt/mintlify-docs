...
- [Transform Node](/developer-guide/workflows/nodes/transform) for simpler JSONata-based transformations
- [HTTP Node](/developer-guide/workflows/nodes/http) to call external APIs without custom code
- [Rule Node](/developer-guide/workflows/nodes/rule) to add conditional logic around custom code
- [Loop Node](/developer-guide/workflows/nodes/loop) to process arrays with custom code