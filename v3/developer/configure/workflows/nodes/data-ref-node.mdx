...
<Tip>Use a [Rule Node](/developer-guide/workflows/nodes/rule) after "Get Ref" actions to branch your workflow based on whether a mapping was found, enabling create-or-update logic.</Tip>

## What's Next

- [Rule Node](/developer-guide/workflows/nodes/rule) to add conditional logic based on ref lookup results
- [Loop Node](/developer-guide/workflows/nodes/loop) to process bulk refs from array data
- [Tables Node](/developer-guide/workflows/nodes/tables) for more complex data storage needs
- [HTTP Node](/developer-guide/workflows/nodes/http) to sync data with external systems after ref lookup