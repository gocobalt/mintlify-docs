...
<AccordionGroup>
  <Accordion title="SFTP Connection Parameters">
    ...
    <Tip>Store SFTP credentials as environment variables under [**Organization > Settings > Environment Variable**](/v3/developer/configure/settings/organization/environment-variables) for secure, reusable configuration.</Tip>
  </Accordion>
...
<Tip>Store SFTP credentials securely as environment variables under [**Organization > Settings > Environment Variable**](/v3/developer/configure/settings/organization/environment-variables) rather than hardcoding them in workflows.</Tip>
