...
<Tip>Use the [Custom Code Node](/developer-guide/workflows/nodes/custom-code) for one-off logic that doesn't need to be reused. Reserve functions for code that will be used across multiple workflows.</Tip>

## What's Next

- [Custom Code Node](/developer-guide/workflows/nodes/custom-code) for one-off custom logic
- [Rule Node](/developer-guide/workflows/nodes/rule) to add conditional logic based on function output
- [Loop Node](/developer-guide/workflows/nodes/loop) to iterate over grouped data from functions
- [Transform Node](/developer-guide/workflows/nodes/transform) for JSONata-based data transformation