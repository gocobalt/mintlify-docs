...
- [Terminate Node](/developer-guide/workflows/nodes/terminate) to end workflows with specific error status
- [Log Node](/developer-guide/workflows/nodes/log) to record error details for debugging
- [Tables Node](/developer-guide/workflows/nodes/tables) to queue failed items for retry
- [Loop Node](/developer-guide/workflows/nodes/loop) to process items with individual error handling