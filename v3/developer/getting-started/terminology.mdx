---
title: "Terminology"
description: "Key terms and concepts in the Refold integration platform"
---

# Terminology

Understanding key terms and concepts will help you navigate the Refold platform effectively.
...
### Linked Account
A representation of one of your end users within Refold's system, allowing them to connect their accounts to various applications.
...
### API Proxy
A feature that allows you to make API calls to integrated services through Refold's infrastructure.
...
### API Key
A unique identifier used to authenticate requests to the Refold API.
