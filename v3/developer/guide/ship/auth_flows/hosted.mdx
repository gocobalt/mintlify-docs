...
It redirects user to Refold Connect hosted on `https://connect.gocobalt.io` and handles the following features:
...
You can also modify the UI of Hosted Portal using the [Hosted_properties API](https://docs.gocobalt.io/api-reference/hosted-properties/get-hosted-properties).
