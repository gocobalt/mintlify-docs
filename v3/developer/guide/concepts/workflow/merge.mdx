...
---
The Merge Node in Refold provides a fundamental functionality for combining multiple branches of a workflow into a single flow. 

This is particularly useful when there are parallel processes within a workflow that need to converge at a common point before proceeding with the subsequent actions. 
...
<img height="200" src="/images/Guides/Workflow/merge-node.png" alt="Merge Node in Refold"/>
### Example Scenario
