...
---
The Custom Code node in Refold enables users to execute custom functions within workflows. Users can leverage their preferred programming language to create custom logic and functionality.
...
<img height="200" src="/images/Guides/Workflow/custom-node.png" alt="Custom Code Node in Refold"/>
...
<Tip>
Learn more about Rule Node [here](https://docs.gocobalt.io/concepts/workflow/rule).
</Tip>
