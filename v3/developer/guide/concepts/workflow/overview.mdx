...
Workflows consist of [Triggers](/concepts/workflow/overview#triggers) and [Actions](/concepts/workflow/overview#actions), allowing for seamless automation and data flow between applications.
...
Learn more about **Events** in our guide [here](/guides/developer-settings/events).
</Accordion>
...
There are various nodes currently provided by Refold. You can learn more about any of the node by clicking on its card below.
<CardGroup cols={2}>

  <Card title="Custom Code" icon="code" href="https://docs.gocobalt.io/concepts/workflow/custom-code">
    This action takes input parameters and uses them to manipulate the data using custom code.
  </Card>

  <Card title="Delay" icon="stopwatch" href="https://docs.gocobalt.io/concepts/workflow/delay">
   Delay allows you to pause the execution of next step till a certain time. 
  </Card>

    <Card title="Group" icon="object-ungroup" href="https://docs.gocobalt.io/concepts/workflow/group">
    This action is used to loop over an entity or a flow for a number of iterations.
  </Card>

    <Card title="HTTP" icon="globe" href="https://docs.gocobalt.io/concepts/workflow/httpnode">
    HTTP Node allows you to create an HTTP Request to any API of the integration.
  </Card>

  <Card title="Merge" icon="object-group" href="https://docs.gocobalt.io/concepts/workflow/merge">
    The Merge Node allows you to merge multiple branches of a workflow into a single flow. 
  </Card>

    <Card title="PDF" icon="file-pdf" href="https://docs.gocobalt.io/concepts/workflow/pdf">
    PDF node helps you to convert HTML to a PDF.
    </Card>


    <Card title="Response" icon="note-sticky" href="https://docs.gocobalt.io/concepts/workflow/response">
    ...
    <Card title="Rule" icon="bolt" href="https://docs.gocobalt.io/concepts/workflow/rule">
    You can add conditional logic to workflows using our rule node.
  </Card>

      <Card title="Send Email" icon="envelope-circle-check" href="https://docs.gocobalt.io/concepts/workflow/email">
    Send Email node lets you send an email through the workflow.
    </Card>

    <Card title="Tables" icon="table" href="https://docs.gocobalt.io/concepts/workflow/datastore">
    Tables node helps you create variables at runtime and add values to them.
    </Card>

    <Card title="Transform" icon="shuffle" href="https://docs.gocobalt.io/concepts/workflow/transform">
