...
**2. Generate Session Token**
  ...
  [Generate a Session Token](https://docs.gocobalt.io/api-reference/session-tokens/generate-session-token) for your Linked Account.
...
Refold provides 3 different ways for Auth flow of integrations
  ...
  <Accordion title="Hosted flow" icon="cloud" description="Redirects user to Refold Connect hosted on `https://connect.gocobalt.io`.">
...
<Tip>
Check out the [Refold's API Reference](https://docs.gocobalt.io/api-reference/connect/create-connect-url) for more details. 
</Tip>
  </Step>
...
You can modify the UI of Hosted Portal using the [hosted_properties](https://docs.gocobalt.io/api-reference/hosted-properties/get-hosted-properties).
...
Retrieve a list of all integrations available to connect using the [List Applications API](https://docs.gocobalt.io/api-reference/applications/list-applications) or [.getApplications()](https://docs.gocobalt.io/sdks/server-side-sdks/nodejs-sdk#getapplications) method and display them in your UI.
<CodeGroup>
