...
**2. Generate Session Token**
  ...
  [Generate a Session Token](/v3/api-reference/session-tokens/generate-session-token) for your Linked Account.
...
<Tip>
Check out the [Refold's API Reference](/v3/api-reference/connect/create-connect-url) for more details. 
</Tip>
  </Step>
...
You can modify the UI of Hosted Portal using the [hosted_properties](/v3/api-reference/hosted-properties/get-hosted-properties).
...
Retrieve a list of all integrations available to connect using the [List Applications API](/v3/api-reference/applications/list-applications) or [.getApplications()](https://docs.gocobalt.io/sdks/server-side-sdks/nodejs-sdk#getapplications) method and display them in your UI.
<CodeGroup>
