...
Use this [API reference](/v3/api-reference/linked-accounts/upsert-linked-account) for a detailed understanding.
...
linked account is being created. Check out this [API reference](/v3/api-reference/linked-accounts/upsert-linked-account) for details.
