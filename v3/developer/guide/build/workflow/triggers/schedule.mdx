...
- [Register Cron Schedule](/v3/api-reference/schedule/register-schedule)

- [Get All Scheduled Jobs](/v3/api-reference/schedule/list-schedules)

- [Pause a Schedule](/v3/api-reference/schedule/pause-schedule)

- [Resume a Schedule](/v3/api-reference/schedule/resume-schedule)

- [Update a Schedule](/v3/api-reference/schedule/update-schedule)

- [Delete a Schedule](/v3/api-reference/schedule/delete-schedule)
