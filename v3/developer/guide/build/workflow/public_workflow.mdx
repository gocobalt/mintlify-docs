...
description: Public workflows in Refold allow linked accounts to create and execute their own workflows.
---
...
/>
```
You need to provide the [Workflow Id](https://docs.gocobalt.io/api-reference/workflows/list-workflows) and [Session Token](https://docs.gocobalt.io/api-reference/session-tokens/generate-session-token).

## Creating Public Workflows

To create a Public workflow, simply use Refold's API
...
```
<Tip>
Learn more about the Create Public Workflow API [here](https://docs.gocobalt.io/api-reference/workflows/create-workflow).
</Tip>
...
```
<Tip>
Learn more about the Create Draft of Public Workflow API [here](https://docs.gocobalt.io/api-reference/workflows/get-draft).
</Tip>
...
Public workflows are triggered just like regular workflows in Refold. The execution depends on the event selected in the Start node.
