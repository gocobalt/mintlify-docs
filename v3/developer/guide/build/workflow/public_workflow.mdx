...
/>
```
You need to provide the [Workflow Id](/v3/api-reference/workflows/list-workflows) and [Session Token](/v3/api-reference/session-tokens/generate-session-token).
...
```
<Tip>
Learn more about the Create Public Workflow API [here](/v3/api-reference/workflows/create-workflow).
</Tip>
...
```
<Tip>
Learn more about the Create Draft of Public Workflow API [here](/v3/api-reference/workflows/get-draft).
</Tip>
