...
The Response Node stores the formatted response data and makes it available through the Workflow API and Refold logs.
...
- **Refold Logs**: Stored response viewable in workflow execution logs
