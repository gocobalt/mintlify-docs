...
<Expandable title="Available Functions">
  ...
  <ResponseField name="Custom Functions" type="function">
    Execute user-defined functions created in the Refold dashboard. Allows for organization-specific logic and reusable business rules. Returns custom-defined output structure.
  </ResponseField>
</Expandable>
...
Custom functions are created and managed in the main Refold dashboard:
