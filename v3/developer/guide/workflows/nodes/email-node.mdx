...
The Email Node allows you to send emails directly through a workflow in Refold. It's designed for internal notifications and alerts, such as notifying your team when a Salesforce contact sync is completed or when workflow processes finish successfully.
...
<Callout type="info">
**Note**: Refold acts as a middle layer for email delivery. Rate limiting and deliverability depend on your SMTP provider settings.
</Callout>
...
**Important**: Refold acts as a middle layer for email delivery. Rate limiting, deliverability, and spam filtering depend on your SMTP provider. Maximum attachment size is 25MB per file.
</Callout>
...
- Test SMTP connection outside of Refold first
