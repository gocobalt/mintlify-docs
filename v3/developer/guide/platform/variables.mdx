---
title: "Variables"
description: "Manage environment variables and dynamic configuration in Refold workflows"
---

# Variables

Learn how to use variables to make your Refold workflows dynamic and configurable across different environments.

## Overview

Variables in Refold allow you to store and reuse values throughout your workflows, making them more flexible and maintainable. You can use variables for API endpoints, authentication tokens, configuration values, and dynamic data processing.
