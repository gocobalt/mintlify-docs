...
See [Server configuration](/v3/mcp/build/server-configuration) for where these toggles live and [How it works](/v3/mcp/overview) for how each mode changes the tool list.
