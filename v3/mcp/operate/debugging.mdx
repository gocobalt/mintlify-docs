...
- **[MCP Logs](/v3/mcp/operate/mcp-logs)** — the audit panel in the Refold dashboard. Shows every tool call your agent made, the exact input it sent, and what came back.
