...
See [Server configuration](/v3/mcp/build/server-configuration) for where these toggles live and [How it works](/v3/mcp/how-it-works) for how each mode changes the tool list.
