...
An MCP server exposes your customers' connected apps as tools an AI agent can call. Create one in the Refold dashboard, connect an MCP client, and run your first tool call.
...
<Steps>
  ...
  <Step title="Copy the Server URL">
    ...
    Refold accepts the token two ways. Use whichever your MCP client supports.
    ...
    <Steps>
      ...
      <Step title="Add your server">
        ...
        ```json Authorization header
        {
          "mcpServers": {
            "refold": {
              "url": "https://<domain>/mcp/v1/<server-id>",
              "headers": {
