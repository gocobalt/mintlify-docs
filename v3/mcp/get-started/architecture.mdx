...
- **Skill** — a reusable procedure attached to an MCP server that tells the agent what to do, in what order, without moving the logic server-side. The agent still makes each tool call itself. See [Skills](/v3/mcp/build/skills).
