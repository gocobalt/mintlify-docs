...
Three things are MCP-specific: the auth token, how access is scoped to the apps and actions you expose, and how to revoke a token. For the connection flows that produce a linked account in the first place (hosted, build-your-own, re-authentication, and more), see the [authentication hub](/v3/platform/authentication/overview).
...
- [Linked accounts](/v3/concepts/linked-account): the account and credential model MCP authentication builds on
