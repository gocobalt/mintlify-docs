...
The tools an agent sees depend on which toggles are enabled on your [server configuration](/v3/mcp/build/server-configuration). For guidance on choosing between direct mode, agent mode, and skill tools, see [Choose your pattern](/v3/mcp/choose-your-pattern).
...
- [Architecture](/v3/mcp/how-it-works): how tools map to actions, workflows, and skills
- [Choose your pattern](/v3/mcp/choose-your-pattern): when to use direct mode, agent mode, or skill tools
- [Skills](/v3/mcp/build/skills): how agents discover and run multi-step procedures
- [Authentication](/v3/authentication/mcp): the token model and access toggles
