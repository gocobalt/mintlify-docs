...
From February 2026, Refold follows unified semantic versioning, where a single version covers a coordinated release across the platform:
...
Releases before February 2026 followed a monthly cadence under an earlier versioning scheme. Those entries are grouped by month and labelled `YYYY.MM` (for example, `2025.09`) for the period they cover.
