...
- **Templated Workflow Env Vars**: Workflow [environment variable](/v3/developer/configure/settings/organization/environment-variables) values now support templating for dynamic resolution.
