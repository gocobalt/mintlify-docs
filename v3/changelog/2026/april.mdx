...
- **Templated Workflow Env Vars**: Workflow [environment variable](/v3/platform/platform-settings/workspace-settings/environment-variables) values now support templating for dynamic resolution.
