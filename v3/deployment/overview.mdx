...
See the [architecture overview](/v3/deployment/architecture) for how Refold's services are structured across each model.
...
You also need outbound network access to the third-party SaaS APIs your integrations call. See [Architecture](/v3/deployment/architecture) for the full picture and [Benchmarking](/v3/deployment/benchmarking) for sizing.
...
<CardGroup cols={2}>
  <Card title="Set up OpenTelemetry" icon="chart-line" href="/v3/deployment/setup-opentelemetry">
    Export traces and metrics for observability.
  </Card>
  <Card title="Configure MinIO" icon="box" href="/v3/deployment/storage-minio">
