...
See the [architecture overview](/v3/deployment/architecture/overview) for how Refold's services are structured across each model.
...
<CardGroup cols={2}>
  ...
  <Card title="Refold Managed (BYOC)" icon="cloud" href="/v3/deployment/kubernetes/refold-managed">
...
You also need outbound network access to the third-party SaaS APIs your integrations call. See [Architecture](/v3/deployment/architecture/overview) for the full picture and [Benchmarking](/v3/deployment/architecture/benchmarking) for sizing.
...
<CardGroup cols={2}>
  <Card title="Set up OpenTelemetry" icon="chart-line" href="/v3/deployment/how-tos/setup-opentelemetry">
    Export traces and metrics for observability.
  </Card>
  <Card title="Configure MinIO" icon="box" href="/v3/deployment/how-tos/storage-minio">
...
<CardGroup cols={2}>
  <Card title="Backup & restore" icon="floppy-disk" href="/v3/deployment/backup-restore">
