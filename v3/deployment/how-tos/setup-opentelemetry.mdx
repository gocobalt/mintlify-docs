...
This applies to [self-hosted](/v3/deployment/overview) deployments, where you operate the cluster and the observability stack. Refold Cloud and Refold Managed are instrumented and monitored for you.
...
- [Deployment overview](/v3/deployment/overview): pick a deployment model and install Refold.
- [Architecture](/v3/deployment/architecture/overview): how Refold's services fit together.
- [Troubleshooting](/v3/deployment/troubleshooting): diagnose common deployment issues.
