...
- **A [workflow](/v3/concepts/workflows/overview)** is the automation that moves data between your app and a connected app. You build it once on the platform and expose it to customers.
