...
Create a persistent table with a set of columns for a linked account. Up to 20 columns can be defined at creation; add more later with [Add Columns](/v3/api-reference/tables/add-columns).
