...
For where these toggles live in the dashboard, see [Server configuration](/v3/mcp/build/server-configuration). For how the modes change what the agent sees, see [How it works](/v3/mcp/overview).
