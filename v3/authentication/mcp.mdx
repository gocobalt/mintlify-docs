...
For where these toggles live in the dashboard, see [Server configuration](/v3/mcp/build/server-configuration). For how the modes change what the agent sees, see [How it works](/v3/mcp/get-started/how-it-works).
...
- [Connectors](/v3/connectors/supported-apps-actions): where the underlying OAuth and API-key credentials are configured
- [Hosted auth flow](/v3/authentication/connection-flows/hosted-flow): how end users connect their accounts in the first place
