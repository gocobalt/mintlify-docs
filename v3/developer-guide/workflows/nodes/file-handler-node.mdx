...
<Steps>
  <Step title="Drag File Handler Node to canvas">
    From the **Utility Nodes** section, drag the File Handler Node to your workflow canvas where you need file processing.
    <Frame>
...
The File Handler Node processes files in the following order:
...
<Tip>Use the Debug Node after File Handler to inspect generated URLs and verify file accessibility before using them in subsequent workflow steps.</Tip>
