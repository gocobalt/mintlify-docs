...
#### Expected Result
Upon firing the event using the Try API feature, it will be logged within the Cobalt system. You can check the logs of the events by navigating to **Events** tab in the [**Logs**](https://docs.gocobalt.io/concepts/logs) section in Cobalt.
