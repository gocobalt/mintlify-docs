...
<Steps>
  ...
  <Step title="Explore platform features">
    Dig into platform features like [workflows](/v3/concepts/workflows/overview), [linked accounts](/v3/concepts/linked-account), and [connectors](/v3/connectors/supported-apps-actions).
  </Step>
</Steps>
