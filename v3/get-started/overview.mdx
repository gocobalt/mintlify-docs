...
<Steps>
  ...
  <Step title="Make your first API call">
    Grab your API key from **Settings > Credentials** in the [Refold Console](https://app.refold.ai/settings/credentials), then make your first request. See the [quickstart](/v3/get-started/quickstart) for a complete walkthrough.
  </Step>
  <Step title="Explore platform features">
    Dig into platform features like [workflows](/v3/concepts/workflows/overview), [linked accounts](/v3/concepts/linked-account), and [connectors](/v3/platform/concepts/connector/supported-apps-actions).
  </Step>
</Steps>
