...
<Note>
  Real connectors may use OAuth 2.0 instead of key-based auth. See [Authentication](/v3/connectors/authentication) to set up an OAuth app for production.
</Note>
...
|---------|--------------|
| [**Native**](/v3/products/overview) | SaaS teams embedding third-party integrations inside their own product |
