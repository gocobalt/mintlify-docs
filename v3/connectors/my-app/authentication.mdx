...
<Tip>
An individual [API proxy](/v3/connectors/my-app/api-proxies) can opt out with **Override Global Token Injection** when it needs different or no authentication.
</Tip>
...
<CardGroup cols={2}>
  <Card title="API proxies" icon="bolt" href="/v3/connectors/my-app/api-proxies">
  ...
  <Card title="Linked accounts" icon="user" href="/v3/native/get-started/linked-accounts">
