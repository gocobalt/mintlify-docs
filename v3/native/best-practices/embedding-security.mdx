...
<Steps>
  ...
  <Step title="Pass it to the frontend">
    Hand the token to the browser and use it to render the connect experience, whether that's the [React SDK flow](/v3/authentication/connection-flows/react-sdk-flow), a [hosted flow](/v3/authentication/connection-flows/hosted-flow), or a [build-your-own](/v3/authentication/connection-flows/build-your-own) UI.
  </Step>
