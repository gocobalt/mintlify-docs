...
<Steps>
  ...
  <Step title="Embed the connect flow in your product">
    Replace the hosted portal with the [React SDK](/v3/native/frontend/react-sdk-flow) or a [build-your-own](/v3/authentication/connection-flows/build-your-own) flow so customers connect without leaving your app.
  </Step>
