...
<Note>
Firing an event is account-scoped: it runs for one [linked account](/v3/platform/concepts/linked-account). Authenticate with your API key and the `linked_account_id`, against the base URL `https://app.refold.ai`.
</Note>
...
| | Events | [Webhooks](/v3/native/configure/developer/webhooks) |
|--|--------|----------|
...
<CardGroup cols={2}>
  <Card title="Build a workflow" icon="diagram-project" href="/v3/native/configure/integration/workflow">
  ...
  <Card title="Receive webhooks" icon="bell" href="/v3/native/configure/developer/webhooks">
