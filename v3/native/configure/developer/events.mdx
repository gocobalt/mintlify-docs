...
<Note>
Firing an event is account-scoped: it runs for one [linked account](/v3/concepts/linked-account). Authenticate with your API key and the `linked_account_id`, against the base URL `https://app.refold.ai`.
</Note>
