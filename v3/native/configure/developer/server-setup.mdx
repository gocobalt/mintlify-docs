...
- **Use the test key in non-production environments** and the production key in production. The key selects the environment. See [Test vs production credentials](/v3/native/configure/developer/developer-app#test-vs-production-credentials).
