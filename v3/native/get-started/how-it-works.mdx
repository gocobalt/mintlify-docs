...
- **Refold** runs the connection and [auth flows](/v3/authentication/overview), stores and refreshes credentials, and executes every [workflow](/v3/concepts/workflows/overview) and action using the stored credential for the right linked account.
