...
Every tool call is authenticated and logged in [MCP Logs](/v3/mcp-ai-agents/security/mcp-logs). For how the server resolves identity and executes each call, see [How it works](/v3/mcp-ai-agents/overview/architecture).
