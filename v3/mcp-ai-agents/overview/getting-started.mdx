...
- A Refold account with at least one [linked account](/v3/developer/configure/linked-account) created
- At least one connector configured with valid credentials — see [Connector setup](/v3/developer/guide/build/connectors/overview)
