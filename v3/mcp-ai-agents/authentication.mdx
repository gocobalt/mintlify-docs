...
This page covers what is MCP-specific: the Server-URL token, how access is scoped to the apps and actions you expose, and how to revoke a token. For the connection flows that produce a linked account in the first place — hosted, build-your-own, re-authentication, and more — see the [authentication hub](/v3/developer/auth/overview).
