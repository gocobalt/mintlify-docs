...
The tools an agent sees depend on which toggles are enabled on your [server configuration](/v3/mcp-ai-agents/overview/architecture). For guidance on choosing between direct mode, agent mode, and skill tools, see [Choose your pattern](/v3/mcp-ai-agents/overview/choose-your-pattern).
...
For the underlying token and access model, see [Authentication](/v3/mcp-ai-agents/authentication).
...
- [Architecture](/v3/mcp-ai-agents/overview/architecture) — how tools map to actions, workflows, and skills
- [Choose your pattern](/v3/mcp-ai-agents/overview/choose-your-pattern) — when to use direct mode, agent mode, or skill tools
- [Skills](/v3/mcp-ai-agents/skills/overview) — how agents discover and run multi-step procedures
- [Authentication](/v3/mcp-ai-agents/authentication) — the token model and access toggles
- [MCP Logs](/v3/mcp-ai-agents/security/mcp-logs) — per-call audit trail with input and output
