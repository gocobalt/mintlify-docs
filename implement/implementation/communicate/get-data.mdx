...
**API Proxies** or **Custom Actions**, allows your organization to integrate your services better with the workflows in Refold. These help you develop Custom Actions for your workflows which can be used to fetch data of the workflows to your system.
...
1. **Create Action** : - Navigate to `Developer` in Refold > `API Proxies` > Click on the `New Action` button > provide a `Name` and `Description` for the API Proxy > Click on the `Create Action` button.
