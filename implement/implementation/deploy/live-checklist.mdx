...
- [Integrate Refold auth flows](https://docs.gocobalt.io/guides/auth-flows/embedded-flow) into your application’s frontend. It should be displayed as a part of your onboarding flow, preferably behind an authentication login.
