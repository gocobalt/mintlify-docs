...
<Tip>
To learn more about the Refold Webhooks, you can refer to our guide [here](https://docs.gocobalt.io/guides/platform/webhook).
</Tip>

Refold Webhook Subscription can be done either through the dashboard or the [Subscribe to Events](https://docs.gocobalt.io/api-reference/webhooks/subscribe-webhook-event) API.
...
2. **Subscription via API**: Users can subscribe to Refold Webhooks using the [Subscribe to Events](https://docs.gocobalt.io/api-reference/webhooks/subscribe-webhook-event) API.
