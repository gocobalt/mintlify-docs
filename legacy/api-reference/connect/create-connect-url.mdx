...
Issue a token with [Generate Session Token](/legacy/api-reference/session-tokens/generate-session-token).
...
<ParamField body="body" type="object">
  Arbitrary JSON properties to stash for the hosted page. Returned verbatim by [Get Hosted Properties](/legacy/api-reference/hosted-properties/get-hosted-properties).
</ParamField>
