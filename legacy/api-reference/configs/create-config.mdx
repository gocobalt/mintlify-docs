...
<ParamField body="fields" type="array">
  Optional initial field definitions, each `{ "id": "...", "value": ... }`. Field **values** are more reliably set after install via [Update Config Field Value](/legacy/api-reference/config-fields/update-field-value).
</ParamField>
...
<Tabs>
  <Tab title="200 OK">
    ...
    <ResponseField name="fields" type="array">Configurable fields (see [Get All Config Fields](/legacy/api-reference/config-fields/get-all-fields)).</ResponseField>
