...
Delete a config installation for an app and a specific `config_id`. (To delete the default config for a linked account, omit the ID — see [Delete Config](/legacy/api-reference/configs/delete-config-default).)
