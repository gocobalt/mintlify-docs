...
<ParamField path="workflow_id" type="string" required>
  The workflow ID. This draft ID is what you pass to [Publish Workflow](/legacy/api-reference/workflows/publish-workflow) — publishing then returns a separate published ID.
</ParamField>
