...
```
Checkout the [auth methods](/legacy/api-reference/sdks) for more details.
...
<Note>Checkout [Refold webhooks](/legacy/guides-v1v2/platform/webhook) for more details.</Note>