...
<Tip>Learn more about UDF parameters in detail here.</Tip>
...
You can create the [**Linked Account**](/legacy/api-reference/linked-accounts/create-linked-account) using the below curl.
...
<Tip>
To learn more about the Logs available, refer [here](/legacy/concepts/logs).
</Tip>
