---
title: Logs
description: Logs in Refold allow you to monitor workflows, troubleshoot errors during executions, and gain insights into platform activities.
---
...
<img height="200" src="/images/Guides/Platform/workflow-logs.png" alt="Workflow Logs Refold"/>
...
<Info> 
To learn more about Try API and how it can be used, refer to our guide [here](/legacy/guides-v1v2/platform/tryapi).
</Info>
...
<img height="200" src="/images/Guides/Platform/workflow-logs-node.png" alt="Execution details of Workflow nodes in Refold"/>
</Accordion>
...
<Note>The retry functionality is limited to a single attempt.</Note>
...
<Info> 
To learn more about Event in Refold, refer to our guide [here](/legacy/guides-v1v2/developer-settings/events).
</Info>
...
<img height="200" src="/images/Guides/Platform/event-logs.png" alt="Event Logs Refold"/>
...
<img height="200" src="/images/Guides/Platform/event-logs-details.png" alt="Details of an Event in Refold"/>
...
<img height="200" src="/images/Guides/Platform/webhook-logs.png" alt="Webhook Logs Refold"/>

<Info> 
To learn more about Webhooks in Refold and how they can be subscribed, refer to our guide [here](/legacy/guides-v1v2/platform/webhook).
</Info>
...
<img height="200" src="/images/Guides/Platform/webhook-logs-details.png" alt="Details of a Webhook in Refold"/>
...
<img height="200" src="/images/Guides/Platform/schedule-logs.png" alt="Schedule Logs Refold"/>
