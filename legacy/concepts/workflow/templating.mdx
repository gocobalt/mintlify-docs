...
Refold supports **templating (dynamic variables)** in creating workflows. This essentially means that users can use these variables in their application workflows and [API Proxies](/legacy/guides-v1v2/developer-settings/api_proxy) and [authorization settings](/legacy/guides-v1v2/developer-settings/overview). 
...
<Accordion title="Access using Test Run variables">
  ...
  <Tip>
Learn more about Workflow Testing and it's pre-requisites [here](/legacy/concepts/workflow/workflow_testing).
  </Tip>
