...
<img height="200" src="/images/Guides/Workflow/workflow_api_setup.png" alt="Setup Workflow API in Refold"/>
  </Step>
</Steps>
...
``` bash cURL
curl --location --request POST 'https://app.refold.ai/api/v1/workflow/{workflow_id or alias}/execute' \
...
``` bash cURL
curl --location --request GET 'https://app.refold.ai/api/v1/execution/{execution_id}/response' \
--header 'linked_account_id: john@acme.io' \
--header 'x-api-key: tkb5b9f358-4160-4fea-a926-cf52b271489d'
```
**Response**
