...
<Tip>
Learn more about API Proxy [here](/legacy/build/basics/proxies).
</Tip>
...
[Linked Accounts](/legacy/build/basics/linked_account) refers to the end-users or customers of our users who utilize the integrations built using the Cobalt platform.
...
<Info>
You can also build your own UI for end-users using our SDKs or APIs and [Auth Flows](/legacy/ship/auth_flows/flows).
</Info>
...
2. **Event based triggers** which triggers when an event is called on Cobalt. You can check which Event is added to the workflow by checking the **Start Node** of the workflow.
    ...
    - To start the workflow execution, go to [**Try API**](/legacy/ship/tryapi) section in Cobalt, provide the required details and click on `Fire Event`.
    <img height="200" src="/images/Guides/Platform/try-api.png" alt="Try API Section in Cobalt"/>

Once the Event is fired, you can see the Event and Execution logs of your workflow by navigating to [**Logs**](/legacy/maintain/logs) section.
