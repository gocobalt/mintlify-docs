...
<Info>
Learn more about DataSource and how to use it in the detailed guide [here](/legacy/build/connectors/config/datasource).
</Info>
...
<Tip>
Learn more about Mapping [here](/legacy/build/connectors/config/mapping).
</Tip>