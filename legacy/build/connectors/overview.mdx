...
Integrating with these platforms are pretty quick and seamless too using our [Auth flow](/legacy/ship/auth_flows/flows) mechanisms.
<img height="200" src="/images/Concepts/app-list.png" alt="Apps in Refold"/>

### Creating and launching Integrations
The end customers can have access to apps enabled by the user. You just need to select from any of the available applications in the [Apps](https://app.refold.ai/applications) section of the platform and enable it.
