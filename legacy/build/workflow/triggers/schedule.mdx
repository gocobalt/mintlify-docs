...
- [Register Cron Schedule](https://docs.gocobalt.io/api-reference/deprecated/schedule-register)

- [Get All Scheduled Jobs](https://docs.gocobalt.io/api-reference/deprecated/schedule-list)

- [Pause a Schedule](https://docs.gocobalt.io/api-reference/deprecated/schedule-pause)

- [Resume a Schedule](https://docs.gocobalt.io/api-reference/deprecated/schedule-resume)

- [Update a Schedule](https://docs.gocobalt.io/api-reference/deprecated/schedule-update)

- [Delete a Schedule](https://docs.gocobalt.io/api-reference/deprecated/schedule-delete)
