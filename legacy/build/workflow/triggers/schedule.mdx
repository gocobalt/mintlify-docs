...
- [Register Cron Schedule](/legacy/api-reference/schedule/register-schedule)

- [Get All Scheduled Jobs](/legacy/api-reference/schedule/list-schedules)

- [Pause a Schedule](/legacy/api-reference/schedule/pause-schedule)

- [Resume a Schedule](/legacy/api-reference/schedule/resume-schedule)

- [Update a Schedule](/legacy/api-reference/schedule/update-schedule)

- [Delete a Schedule](/legacy/api-reference/schedule/delete-schedule)
