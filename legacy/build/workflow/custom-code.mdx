...
<Tip>
To know more about all the libraries supported, refer [here](/legacy/build/workflow/custom-code#supported-javascript-libraries). 
</Tip>
...
The full list for the supported npm modules can be found below. If you don't see the module that you want, [contact us](mailto:support@refold.ai) and we will get that added.
