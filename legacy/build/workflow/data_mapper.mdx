...
<Tip>
Learn more about Field Mapping [here](/legacy/build/connectors/config/mapping).
</Tip>
...
- **Mapping**: Using [Templating](/legacy/build/workflow/templating), you pass the config mapping which will be used to map fields in this node.
