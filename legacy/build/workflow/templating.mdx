...
Refold supports **templating (dynamic variables)** in creating workflows. This essentially means that users can use these variables in their application workflows and [API Proxies](/legacy/build/basics/proxies) and [authorization settings](/legacy/build/basics/developer_settings). 
...
<Tip>
Learn more about Workflow Testing and it's pre-requisites [here](/legacy/build/workflow/workflow_testing).
</Tip>
