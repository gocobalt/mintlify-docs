...
*For node-specific documentation, see the [Workflows section](/legacy/build/workflow/overview). For authentication and Custom App setup, see [Custom Apps](/legacy/custom_app/custom_app). For platform updates, see the [Changelog](/v3/changelog/overview).*
