---
title: CSV/Excel by Refold
---
<Info>
If your file size is greater than 5MB, then it's recommended to use [File Handler](/legacy/build/workflow/file_handler) node.
</Info>
...
<img height="200" src="/images/Guides/Workflow/csv-node.png" alt="CSV/Excel Node in Refold"/>
