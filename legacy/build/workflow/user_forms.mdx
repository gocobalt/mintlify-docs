...
<Tip>
Learn more about Human Task [here](/legacy/build/workflow/human_task).
</Tip>

## Create User Forms

To create a form, navigate to `User Forms` under **Advanced** section in side menu in the Refold dashboard.
<img height="200" src="/images/Developer/user_forms.png" alt="Create User forms in Refold"/>
...
<Steps>
  ...
  <Step title="Modify field details">
    ...
    <img height="200" src="/images/Developer/user_forms_field.png" alt="Create User forms fields in Refold"/>
    <Tip>
  ...
  <Step title="Form is ready">
    ...
    <img height="200" src="/images/Developer/user_form.png" alt="Create User form in Refold"/>
  </Step>
</Steps>
