...
description: Workflow Testing in Refold enables you to test your workflow's functionality by running it with sample payloads as you build it.
---
...
Click the `Testing` button in the workflow editor side menu and select a **[Linked Account](/legacy/build/basics/linked_account)** under `Prerequisites` section.
...
<Tip>
To learn more about how to do Templating in Refold, refer to the docs [here](/legacy/build/workflow/templating).
</Tip>
