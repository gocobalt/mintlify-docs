...
<Info>
If you want to learn more about Custom Code Node, refer [here](/legacy/build/workflow/custom-code).
</Info>
...
<img height="200" src="/images/Guides/Nodes/functions_create.png" alt="Create Functions"/>
  ...
  <Step title="Write function">
    ...
    <Info>
    You can also use JavaScript Libraries supported by Refold in the function code. Refer [here](/legacy/build/workflow/internal_functions#supported-javascript-libraries-and-usage) to check the list of supported libraries.
    </Info>
  </Step>
</Steps>
<Tip>
...
The full list for the supported npm modules that can be used to write your own internal function is below. If you don't see the module that you want, [contact us](mailto:support@refold.ai) and we will get that added.
