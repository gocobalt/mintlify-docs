...
- [Integrate Refold auth flows](/legacy/ship/auth_flows/flows) into your application’s frontend. It should be displayed as a part of your onboarding flow, preferably behind an authentication login.
...
- [Handle Re-Authentication](/legacy/ship/auth_flows/re-auth-flow) of users if required for any application.
...
- [Workflow testing](/legacy/build/workflow/workflow_testing) will make sure that the Workflow is able to provide the required functionality.
