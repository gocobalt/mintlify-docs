...
<Tip>
Follow the steps given [here](/applications/providers/netsuite) to get your API credentials required for authentication.
</Tip>
...
<Tip>
Learn more about Loop node [here](/legacy/build/workflow/group).
</Tip>
...
<Tip>
Learn more about Table node [here](/legacy/build/workflow/tables).
</Tip>
