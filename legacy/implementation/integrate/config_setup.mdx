...
<Tip>
Learn more about Config and its types [here](/legacy/build/connectors/config/config).
</Tip>
...
<Tip>
Learn more about Select Field Type [here](/legacy/build/connectors/config/field_type_intro#select-field-types).
</Tip>
...
<Note>
To use this dataslot in the [Sync workflow](/legacy/implementation/workflow/sync_using_proxy), you would need to change the action in Node 2 to `Get Contacts Of A particular List` and provide this dataslot in **Enter List ID** field.
</Note>

You can get this Config of your users after they perform selection by using the Config API or SDK Method.

<Info>
Navigate [here](/legacy/implementation/integrate/end-user-config) to learn how you can manage Configs for your end users.
</Info>
