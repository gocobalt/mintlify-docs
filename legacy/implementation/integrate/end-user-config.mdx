...
1. **Request** - You can use the **.updateconfig()** method or the [Update Config API](https://docs.gocobalt.io/api-reference/configs/update-config) which updates the specified config of a Linked Account. You can also enable or disable the Workflows of a user by updating the config.
<CodeGroup>
``` JavaScript Method
cobalt.updateConfig({
  slug: "slack",
