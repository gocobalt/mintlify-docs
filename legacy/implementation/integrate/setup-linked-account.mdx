...
You can check the Linked Accounts present in your account by using the [List Linked Accounts API](/legacy/api-reference/linked-accounts/list-linked-accounts) Or through the **Cobalt Dashboard** by navigating to `Linked Accounts` in the side menu.
<img height="200" src="/images/implementation/la.png" alt="Linked Accounts on Dashboard"/>

### Checkpoint + Next Step 

<Check>
After completing this step, you have successfully created Linked Accounts of your end-users. This will now allow your clients to make a request to the Cobalt APIs successfully by using their **Session Tokens** which we will create in the [next step](/legacy/implementation/integrate/get-access-token).
</Check>