...
description: To diplay the apps to your end-users in the frontend, you can develop your own custom UI or redirect your users to Refold Connect.
---
...
## Building Custom UI
To build a custom UI for your integrations, you can do so by using the [Refold SDKs](/legacy/api-reference/sdks) or the [List Applications API](/legacy/api-reference/applications/list-applications).
...
<Step title="Request">
Call the **.getapp()** method provided in the SDK or the [List Applications API](/legacy/api-reference/applications/list-applications) to get a list of enabled apps.
<CodeGroup>
``` JavaScript JS SDK
...
```
<Note>
Learn more about the Embedded and Seamless flow of Refold Connect [here](/legacy/ship/auth_flows/flows).
</Note>
</Step>
</Steps>
