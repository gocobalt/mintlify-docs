...
## Building Custom UI
To build a custom UI for your integrations, you can do so by using the [Cobalt SDKs](/legacy/api-reference/sdks) or the [List Applications API](/legacy/api-reference/applications/list-applications).
...
```
<Note>
Learn more about the Embedded and Seamless flow of Cobalt Connect [here](/legacy/ship/auth_flows/flows).
</Note>
</Step>
</Steps>
