...
## Building Custom UI
To build a custom UI for your integrations, you can do so by using the [Cobalt SDKs](/sdks/client-side-sdks/js-sdk#getapp) or the [List Applications API](https://docs.gocobalt.io/api-reference/applications/list-applications).
...
<Step title="Request">
Call the **.getapp()** method provided in the SDK or the [List Applications API](https://docs.gocobalt.io/api-reference/applications/list-applications) to get a list of enabled apps.
<CodeGroup>
``` JavaScript JS SDK
