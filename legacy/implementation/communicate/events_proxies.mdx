...
<Info>
To learn more about how you can create a sample workflow with an API Proxy, refer to our guide [here](/legacy/implementation/workflow/sync_using_proxy).
</Info>
...
<Info>
To learn more about how you can create a sample workflow with an Event, refer to our guide [here](/legacy/implementation/workflow/create_using_event).
</Info>
