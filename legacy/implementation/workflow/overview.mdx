...
<Tip>
Learn more about Workflows [here](/legacy/build/workflow/overview).
</Tip>
...
- [Sync Opportunities from Salesforce](/legacy/implementation/workflow/sync_using_proxy)

- [Create Contact in Salesforce](/legacy/implementation/workflow/create_using_event)