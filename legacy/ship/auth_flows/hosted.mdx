...
It redirects user to Hosted Portal hosted on `https://app.refold.ai/connect` and handles the following features:
...
You can also modify the UI of Hosted Portal using the [Hosted_properties API](/legacy/api-reference/hosted-properties/get-hosted-properties).
