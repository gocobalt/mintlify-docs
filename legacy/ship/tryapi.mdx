---
title: Try API
description: More about the Try API Settings and how it can assist you to fire and test workflows in Refold.
---
...
<Steps>
  ...
  <Step title="Execute">
    ...
    <img height="200" src="/images/Guides/Platform/try-api_execute.png" alt="Try API Execute Workflow in Refold"/>
  </Step>
</Steps>
</Accordion>
...
#### Expected Result
Upon firing or executing, it will be logged within the Refold system. You can check the logs by navigating to [**Logs**](/legacy/maintain/logs) section in Refold.
