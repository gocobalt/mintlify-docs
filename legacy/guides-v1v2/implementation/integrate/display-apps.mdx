...
description: To diplay the apps to your end-users in the frontend, you can develop your own custom UI or redirect your users to Hosted Portal.
---
...
## Building Custom UI
To build a custom UI for your integrations, you can do so by using the [Refold SDKs](/legacy/api-reference/sdks) or the List Applications API.
...
```
<Note>
Learn more about the Embedded and Seamless flow of Hosted Portal [here](/legacy/ship/auth_flows/flows).
</Note>
</Step>
</Steps>
