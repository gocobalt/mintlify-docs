---
title: Apps Setup
description: Setup the 3rd Party Apps that you can connect with Refold.
---
...
The end customers can have access to apps enabled by the user. You just need to select from any of the available applications in the [Apps](https://app.refold.ai/applications) section of the platform and enable it by clicking on `Go Live`.
