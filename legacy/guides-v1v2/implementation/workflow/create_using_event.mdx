...
<Tip>
Refer to the Trigger Event API [here](/legacy/api-reference/events/trigger-event) to fire the event and workflow.
</Tip>
...
<Tip>
Learn in depth how you can configure the pre-requisites in our Workflow Testing guide [here](/legacy/build/workflow/workflow_testing#pre-requisites-for-workflow-testing).
</Tip>
