...
<Tip>
Learn more about how to create workflows [here](/legacy/build/workflow/overview).
</Tip>
...
#### Expected Result
Upon firing the event using the Try API feature, it will be logged within the Refold system. You can check the logs of the events by navigating to **Events** tab in the [**Logs**](/legacy/concepts/logs) section in Refold.
