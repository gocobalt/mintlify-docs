...
You can add UDF Parameters to the Linked Accounts either programmatically or by the UI of Refold. Using either the Upsert Linked Account API or [**.upsertLinkedAccount()**](/legacy/api-reference/sdks) method of the NodeJS SDK, you can add UDF parameter.
<Info>
