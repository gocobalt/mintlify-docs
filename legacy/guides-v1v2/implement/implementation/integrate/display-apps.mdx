...
If you want to create your own frontend for the integration and want to fetch information about the various integrations that will be available to the end-users, you can do so by using the [List Applications API](https://docs.gocobalt.io/api-reference/applications/list-applications).
