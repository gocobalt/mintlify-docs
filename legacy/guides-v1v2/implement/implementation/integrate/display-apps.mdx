...
description: To diplay the apps to your end-users in the frontend, you can develop your own custom UI or redirect your users to Hosted Portal, which is securely hosted by Refold.
---
...
## Building Custom UI
If you want to build a custom UI for your integrations, you can do so by using the Refold APIs or the Hosted Portal SDK available in JavaScript and React. 
<AccordionGroup>
...
```
<Note>
Learn more about the Embedded and Seamless flow of Hosted Portal [here](/legacy/concepts/auth-flows/auth-flows).
</Note>
  </Accordion>
</AccordionGroup>
