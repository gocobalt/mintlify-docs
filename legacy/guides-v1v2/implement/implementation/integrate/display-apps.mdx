...
You can also fetch information about a single application by providing the app slug in the [Get Application API](https://docs.gocobalt.io/api-reference/applications/get-application).
...
```
<Note>
Learn more about the Embedded and Seamless flow of Hosted Portal [here](https://docs.gocobalt.io/concepts/auth-flows/auth-flows).
</Note>
  </Accordion>
</AccordionGroup>
