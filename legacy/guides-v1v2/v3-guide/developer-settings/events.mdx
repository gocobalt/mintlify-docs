...
To trigger an event from Cobalt platform so that you can simulate event execution, test workflows and validate the behavior of associated actions, you can use the `Try API` feature of Cobalt. Refer [here](/legacy/guides-v1v2/platform/tryapi) to learn how you can use Try API.
