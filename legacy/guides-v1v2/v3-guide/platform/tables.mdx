...
All persistent tables created in the Cobalt platform can be accessed by navigating to `Settings` > [Tables](https://app.refold.ai/tables). This section provides details about each table, such as its ID and Name.
