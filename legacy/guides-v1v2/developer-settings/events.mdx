...
Events are the trigger entities that are used to define a start point of a workflow and can be triggered using the [REST APIs](/legacy/api-reference/events/trigger-event) or the Event URL assigned for the Organization.
