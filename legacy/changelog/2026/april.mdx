...
- **Templated Workflow Env Vars**: Workflow [environment variable](/legacy/build/workflow/environment-variables) values now support templating for dynamic resolution.
