...
Similar to the native apps offered by Refold, Custom Apps provide the following features:
...
A custom app can be created using any of the three methods offered by Refold. 

The prerequisites for building a Custom Integration of any app provider on Refold are:
...
<Card title="Create Custom App from Scratch" icon="plus" href="/legacy/custom_app/custom_app_scratch">
  In this, you create a custom app from scratch by setting its authentication method, API Endpoints etc.
</Card>

<Card title="Create Custom App using Refold AI" icon="microchip-ai" href="/legacy/custom_app/custom_app_ai">
...
<Card title="Create Custom App using OpenAPI Spec" icon="file-code" href="/legacy/custom_app/custom_app_openapi">
