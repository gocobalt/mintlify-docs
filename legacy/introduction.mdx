...
<CardGroup cols={3}>
  <Card
    title="Cobalt Basics"
    icon="palette"
    href="/legacy/build/basics/linked_account"
  >
  ...
  <Card
    title="Auth Flows"
    icon="code"
    href="/legacy/ship/auth_flows/flows"
  >
  ...
  <Card
    ...
    href="/legacy/build/workflow/overview"
  >
  ...
  <Card
    title="Webhooks"
    icon="flag"
    href="/legacy/build/basics/webhooks"
  >
	...
	>
		<CardGroup cols={1}>
			<Card
				title="Vanilla JS"
        icon="js"
				href="/legacy/api-reference/sdks"
			>
