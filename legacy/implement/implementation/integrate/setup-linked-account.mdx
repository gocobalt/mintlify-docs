...
<Info> 
To learn more about Linked Accounts, you can refer to the Linked Accounts Guide [here](https://docs.gocobalt.io/concepts/linked_account).
</Info>

### Using Cobalt API or SDK
Use the [Upsert Linked Account API](https://docs.gocobalt.io/api-reference/linked-accounts/upsert-linked-account) call below or the **.upsertLinkedAccount()** method of the [NodeJS SDK](https://docs.gocobalt.io/sdks/server-side-sdks/nodejs-sdk) to create or update a linked account.
<CodeGroup>
```bash cURL
curl --request PUT \
...
You can check the Linked Accounts present in your account by using the [List Linked Accounts API](https://docs.gocobalt.io/api-reference/linked-accounts/list-linked-accounts) Or through the **Cobalt Dashboard** by navigating to `Linked Accounts` in the side menu.
