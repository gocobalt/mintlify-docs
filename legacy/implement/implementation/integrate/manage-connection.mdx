...
The **.connect()** method in the [JS SDK](/legacy/api-reference/sdks) by Cobalt lets your customers to connect to an application platform, authorizing you to access the platform APIs and data on their behalf.
``` JavaScript Method
