...
Cobalt Webhook Subscription can be done either through the dashboard or the [Subscribe to Events](https://docs.gocobalt.io/api-reference/deprecated/webhook-subscribe) API.
...
2. **Subscription via API**: Users can subscribe to Cobalt Webhooks using the [Subscribe to Events](https://docs.gocobalt.io/api-reference/deprecated/webhook-subscribe) API.
