...
<Tip>
To learn more about the Cobalt Webhooks, you can refer to our guide [here](/legacy/guides-v1v2/platform/webhook).
</Tip>

Cobalt Webhook Subscription can be done either through the dashboard or the [Subscribe to Events](/legacy/api-reference/webhooks/create-webhook) API.
...
2. **Subscription via API**: Users can subscribe to Cobalt Webhooks using the Subscribe to Events API.
