...
You can add UDF Parameters to the Linked Accounts either programmatically or by the UI of Refold. Using either the [Upsert Linked Account](/legacy/api-reference/linked-accounts/upsert-linked-account) API or [**.upsertLinkedAccount()**](/legacy/api-reference/sdks) method of the NodeJS SDK, you can add UDF parameter.
<Info>
...
To configure the Access Controls, go to the Workflow in Refold for which you want to do so.
