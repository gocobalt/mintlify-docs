...
You can send data from your apps to other apps by using Refold **Events**.
...
<Info>
To learn more about Refold Events, you can refer to our guide [here](/legacy/guides-v1v2/developer-settings/events).
</Info>
...
1. **Create Event** : Navigate to `Developer` in Refold > `Events` > Click on `New Event` > Select a `Model` > Update the sample Payload to your requirements > Click on `Create Event`.
    <img height="200" src="/images/custom_event.png" alt="Create an Event in Refold"/>
