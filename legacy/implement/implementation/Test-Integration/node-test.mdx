...
<Tip>
Learn more about the Nodes available in Cobalt [here](/legacy/build/workflow/tables).
</Tip>
...
<Info>
Learn more about how Try API works in Cobalt [here](/legacy/guides-v1v2/platform/tryapi).
</Info>
