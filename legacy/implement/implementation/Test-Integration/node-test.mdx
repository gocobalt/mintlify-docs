...
<Tip>
Learn more about the Nodes available in Refold [here](/legacy/build/workflow/tables).
</Tip>
...
<Tip>
Learn more about the Transform Node [here](/legacy/build/workflow/transform).
</Tip>
...
<Tip>
Learn more about the Rule Node [here](/legacy/build/workflow/rule).
</Tip>

## Execution and Verification Process
Follow the steps mentioned below to perform Node level testing in Refold:
...
<Info>
Learn more about how Try API works in Refold [here](/legacy/guides-v1v2/platform/tryapi).
</Info>

4. **Verify Results**: Compare the response obtained with the expected outcomes to ensure correctness. You can check the Node response by navigating to `Logs` in Refold > `Executions` > Check the Workflow logs.
<Tip>
...
<Check>
You have now successfully created and tested all the nodes of your workflow. Next Step is to perform [Orchestration Level testing](/legacy/implementation/Test-Integration/orchestration-test) to check whether workflows work correctly or not.
</Check>