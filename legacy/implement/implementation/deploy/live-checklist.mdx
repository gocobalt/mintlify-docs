...
- [Integrate Cobalt auth flows](https://docs.gocobalt.io/guides/auth-flows/embedded-flow) into your application’s frontend. It should be displayed as a part of your onboarding flow, preferably behind an authentication login.
...
- [Integrate the Cobalt APIs](https://docs.gocobalt.io/api-reference/linked-accounts/get-linked-account) or SDKs for Listing Applications, Config etc. into your application’s backend.
...
- [Handle Re-Authentication](https://docs.gocobalt.io/implementation/additional/reauth) of users if required for any application.
...
- [Workflow Failures](https://docs.gocobalt.io/implementation/additional/workflow-failure) are properly handled on your platform.
- Check if the access of a workflow is provided to the required Linked accounts or not using the [Access Control](https://docs.gocobalt.io/implementation/additional/workflow-access).
...
- [Orchestration testing](https://docs.gocobalt.io/implementation/Test-Integration/orchestration-test) will make sure that the Workflow is able to provide the required functionality.
