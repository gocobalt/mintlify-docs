...
2. [Read](https://docs.gocobalt.io/implementation/communicate/get-data) and [Write](https://docs.gocobalt.io/implementation/communicate/write-data) Data to Third-party Apps from Cobalt.
