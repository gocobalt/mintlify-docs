...
You can now either create a Custom UI for displaying the applications or use the Hosted Flow provided by Cobalt.
...
```
<Note>
Learn more about the Assisted and Seamless flow of Cobalt Connect [here](https://docs.gocobalt.io/guides/auth-flows/embedded-flow).
</Note>

<Check>
Your Custom UI to display apps using the Cobalt API or SDK is built.
</Check>

## Hosted Flow UI
This is a no-code solution provided by Cobalt so you don't need to build your own UI. In this, you can effortlessly redirect your users’ to Cobalt Connect.

To get started with this, you first need to [generate a Hosted/Connect URL](https://docs.gocobalt.io/api-reference/cobalt-connect/get-connect-url) using API for your end-user by using the Session Token generated for them [here](https://docs.gocobalt.io/implementation/integrate/get-access-token).
``` JavaScript Request
curl --request POST \
...
```
In the Response of the request, you get the Hosted URL which can be used to redirect the user to the hosted UI or can be embedded within your UI.
``` JavaScript Response
{
    "hosted_url": "https://connect.gocobalt.io/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJvcmdfaWQiOiI2M2M5M2lMTciLCJsaW5rZWRfYWNjb3VudF9pZCI6IjEyMzQ1Njc4IiwiZW52aXJvbm1lbnQiOiJ0ZXN0IiwiaWF0IjoxNjg2NzM1ODMxLCJleHAiOjE2ODY5OTUwMzF9.DOKY6iXkfjdladdovGL8"
}
```
<img height="200" src="/images/Guides/Account-management/am-brand-linked.png" alt="Hosted Flow UI"/>
<Note>
To learn more about the Hosted Flow, refer to our guide [here](https://docs.gocobalt.io/guides/auth-flows/hosted-flow).
</Note>

## Checkpoint + Next Step
<Check>
You have now successfully built a UI for your end users which displays all the integrations enabled for them. Next step is to [Manage Connections](https://docs.gocobalt.io/implementation/integrate/manage-connection) for your customers.
</Check>