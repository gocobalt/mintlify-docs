...
Follow the steps mentioned below to perform Orchestration testing in Refold:
...
<Steps>
  ...
  <Step title="Monitor and Analyze">
    ...
    Compare the actual response with expected results to ensure the workflow functions as intended. To check the status of Workflow, navigate to `Logs` > `Executions` in Refold and check the workflow status.
    <Tip>
