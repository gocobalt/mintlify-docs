...
<Tip>
Learn more about the Nodes available in Refold [here](https://docs.gocobalt.io/guides/workflow/datastore).
</Tip>
...
<Info>
Learn more about how Try API works in Refold [here](https://docs.gocobalt.io/guides/platform/tryapi).
</Info>
