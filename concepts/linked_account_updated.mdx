...
<Frame>
    <img src="/images/Linked Account/Overview.png" />
</Frame>
...
<Info>**Linked account id** should be `unique` for every user. It can be any unique `id` eg. `email` or `primary key` representing the user</Info>
