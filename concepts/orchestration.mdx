...
#### Logs
Cobalt provides detailed insights of any orchestration through event, workflow, webhook and schedule [logs](/concepts/logs) so that user has a better understanding od what happens under the hood.
