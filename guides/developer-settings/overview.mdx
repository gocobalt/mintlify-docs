...
<img height="200" src="/images/developer-setting-auth.png" alt="Setting up api authentication for default app"/>
...
<img height="200" src="/images/injection.png" alt="Setting up auth header for a default action"/>
