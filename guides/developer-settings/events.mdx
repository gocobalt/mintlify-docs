...
while you are triggering this event. This is because, the properties defined in the sample payload can be used as trigger variables inside a workflow by entering `$`.
