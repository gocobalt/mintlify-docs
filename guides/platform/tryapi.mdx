---
title: Try API
description: More about the Try API Settings and how it can assist you to fire and test events in Refold.
---

The **Try API** feature in Refold allows users to simulate event execution, providing a convenient way to test workflows and validate the behavior of associated actions. By firing events from the Try API interface, users can verify the correctness and responsiveness of their workflows.
...
<Tip>
Learn more about how to create workflows [here](https://docs.gocobalt.io/guides/workflow/overview).
</Tip>
...
#### Expected Result
Upon firing the event using the Try API feature, it will be logged within the Refold system. You can check the logs of the events by navigating to **Events** tab in the [**Logs**](https://docs.gocobalt.io/concepts/logs) section in Refold.
<img height="200" src="/images/Guides/Platform/try-api-logs.png" alt="Logs of Try API in Refold"/>
