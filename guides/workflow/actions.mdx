...
## Cobalt's custom actions
You can create [custom actions](https://docs.gocobalt.io/guides/developer-settings/api_proxy) or **API Proxies** of your organization for your customers to use in the developer settings.
