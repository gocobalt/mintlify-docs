...
Within the workflow, add a Delay node along with start and app nodes to define the workflow flow. Connect the nodes in sequence: **start node > delay node > app node (add action)**.
