...
5. In **Refold**, go to your [`Apps catalog`](https://app.gocobalt.io/apps) > Search for `Shopify` > `Settings` > `Use your credentials` > `Callback Url`. Copy the Callback URL as provided in your Shopify settings page.
