...
4. Go to your [`Apps catalog`](https://app.refold.ai/applications) in **Refold** > Search for `Epic` > `Settings` > `Use your credentials` > `Callback Url` > Copy it. Paste the Callback URL under `Redirect URI` in the app.
