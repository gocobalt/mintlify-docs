...
3. **Callback URI** - https://app.refold.ai/api/v1/lever/callback
...
That's it, your users can now connect with your Lever applications through their [auth flow](/v3/platform/authentication/overview) setups. They would be requested permissions as per the scopes selected
