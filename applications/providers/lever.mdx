...
That's it, your users can now connect with your Lever applications through their [auth flow](/v3/authentication/overview) setups. They would be requested permissions as per the scopes selected
