...
2. Pardot Business Unit setup completed. Know more about how to do this [here](/applications/providers/pardot_create).
3. Required Settings for the App. You can find it in [Overview](/applications/providers/pardot_overview#required-settings).
...
7. Enter the Callback URL as provided in your Pardot settings page in Refold. Go to your [`Apps catalog`](https://app.refold.ai/applications) > Search for `Pardot` > `Settings` > `Use your credentials` > `Callback Url`.
