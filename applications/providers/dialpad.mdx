...
- **Redirect URIs**: Go to your [`Apps catalog`](https://app.refold.ai/applications) in **Refold** > Search for `Dialpad` > `Settings` > `Use your credentials` > `Callback Url` > Copy it. Provide this URL to Dialpad in the form.
