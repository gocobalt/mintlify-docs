...
2. Required Settings for the App. You can find it in [Overview](/applications/providers/salesforce_overview#required-settings).
...
7. Enter the Callback URL as provided in your Salesforce settings page in Refold. Go to your [`Apps catalog`](https://app.refold.ai/applications) > Search for `Salesforce` > `Settings` > `Use your credentials` > `Callback Url`.
...
<Steps>
  ...
  <Step title="Add URL">
    Provide a **Name** of the Remote Site, add `https://app.refold.ai` under **Remote Site URL** and click on `Save`.
