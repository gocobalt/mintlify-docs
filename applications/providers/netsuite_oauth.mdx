...
5. Go to your [`Apps catalog`](https://app.refold.ai/applications) in **Refold** > Search for `Netsuite` > `Settings` > `Use your credentials` > `Callback Url` > Copy it. Paste the Callback Uri under `Redirect URI` field under **OAuth 2.0** in the app.
