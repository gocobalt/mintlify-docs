...
2. Jira OAuth app credentials added to Refold. Refer [here](/applications/providers/jira#creating-an-app-in-jira).
3. Trigger created in Refold. Refer [here](/v3/platform/concepts/workflows/triggers/overview).
4. Linked Account available. Refer [here](/applications/providers/jira#creating-an-app-in-jira).
...
* Go to your [`Apps catalog`](https://app.refold.ai/applications) in **Refold** > Search for `Jira` > `Workflows` > `Add Workflow` > Choose `Manually` > Give it a name and click on `Add Workflow`.
...
<Tip>
Learn more about the Transform Node [here](/v3/platform/concepts/workflows/nodes/transform).
</Tip>
