...
2. Required Settings for the App. You can find it in [Overview](/applications/providers/slack_overview#required-settings).
...
4. Copy the Callback URL as provided in your Slack settings page in Refold. Go to your [`Apps catalog`](https://app.refold.ai/applications) > Search for `Slack` > `Settings` > `Use your credentials` > `Callback Url`.
