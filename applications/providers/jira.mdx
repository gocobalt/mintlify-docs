...
2. Required Settings for the app. You can find it in [Overview](/applications/providers/jira_overview#required-settings).
...
4. Go to your [`Apps catalog`](https://app.refold.ai/applications) in Refold > Search for `Jira` > `Settings` > `Use your credentials` > `Callback Url` > Copy it.
