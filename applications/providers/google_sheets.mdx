...
5. Go to your [`Apps catalog`](https://app.gocobalt.io/apps) in **Refold** > Search for `Google Sheets` > `Settings` > `Use your credentials` > `Callback Url` > Copy it.
...
Navigate to  `Cloud Console dashboard` > Select the **Project** created for Refold > Follow the steps 8 and 9 mentioned [above](https://docs.gocobalt.io/resources/integration-providers/google_sheets#creating-an-app-in-google-drive) for adding scopes. 
