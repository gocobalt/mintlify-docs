...
7. Go to your [`Apps catalog`](https://app.refold.ai/applications) > Search for `Salesforce Finance` > `Settings` > `Use your credentials` > `Callback Url` > Copy it. Paste this under the `Callback URL` field of the app.
