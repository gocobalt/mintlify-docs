...
5. Go to your [`Apps catalog`](https://app.refold.ai/applications) in **Refold** > Search for `Microsoft Defender` > `Settings` > `Use your credentials` > `Callback Url` > Copy it.
...
Select the OAuth App created for Refold and follow **Step 8** and **9** [above](/applications/providers/msdefender#creating-an-app-in-microsoft-azure).
