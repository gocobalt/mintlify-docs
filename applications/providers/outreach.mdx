...
5. Go to your [`Apps catalog`](https://app.refold.ai/applications) in **Refold** > Search for `Outreach` > `Settings` > `Use your credentials` > `Callback Url` > Copy it. Under `Callback URL`, click on `+ Add new URL` and paste it.
