...
5. Go to your [`Apps catalog`](https://app.refold.ai/applications) in **Refold** > Search for `Microsoft One Drive` > `Settings` > `Use your credentials` > `Callback Url` > Copy it.
...
Select the OAuth App created for Refold and follow **Step 7** and **8** [above](/applications/providers/ms_one_drive#creating-an-app-in-microsoft-azure).
