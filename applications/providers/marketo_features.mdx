...
2. Trigger created in Refold. Refer [here](/v3/platform/concepts/workflows/triggers/overview).
3. Linked Account available. Refer [here](/v3/platform/concepts/linked-account).
