...
5. Go to your [`Apps catalog`](https://app.refold.ai/applications) in **Refold** > Search for `Azure Security Centre` > `Settings` > `Use your credentials` > `Callback Url` > Copy it.
...
Select the OAuth App created for Refold and follow **Step 7** and **8** [above](/applications/providers/azure_security_center#creating-an-app-in-microsoft-azure).
