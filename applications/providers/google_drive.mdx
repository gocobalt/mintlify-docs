...
---
To setup your Google Drive app in Refold for OAuth, you will need the following credentials from your [Google Cloud Console dashboard](https://console.cloud.google.com/projectselector2/home/dashboard?supportedpurview=project):
- Client ID
- Client Secret
- Scopes
...
5. Go to your [`Apps catalog`](https://app.gocobalt.io/apps) in **Refold** > Search for `Drive` > `Settings` > `Use your credentials` > `Callback Url` > Copy it.
...
Navigate to  `Cloud Console dashboard` > Select the **Project** created for Refold > Follow the steps 8 and 9 mentioned [above](https://docs.gocobalt.io/resources/integration-providers/google_drive#creating-an-app-in-google-drive) for adding scopes. 
