...
- **Re-direct URI**: Go to your [`Apps catalog`](https://app.refold.ai/applications) in **Refold** > Search for `Pandle` > `Settings` > `Use your credentials` > `Callback Url` > Copy it. Provide this URL to Pandle support in the mail.
