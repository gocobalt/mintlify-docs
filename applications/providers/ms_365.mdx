...
5. Go to your [`Apps catalog`](https://app.refold.ai/applications) in **Refold** > Search for `Ms365` > `Settings` > `Use your credentials` > `Callback Url` > Copy it.
...
Select the OAuth App created for Refold and follow **Step 7** and **8** [above](/applications/providers/ms_365#creating-an-app-in-microsoft-azure).
